...
int Reporte::Reporte_DISK(QString id_part, QString ruta, QString value){
...
int Reporte::Reporte_MBR(QString id_part, QString ruta, QString value){
    int posicion=Verificar_montaje(id_part);
    if(posicion==-1){return 0;}
...
int Reporte::Reporte_SB(QString id_part, QString ruta, QString value){
    int posicion=Verificar_montaje(id_part);
    if(posicion==-1){
...
int Reporte::Reporte_BM_Inode(QString id_part, QString ruta, QString value){
    int posicion=Verificar_montaje(id_part);
    if(posicion==-1){
        cout<<"ERROR:: no se puede generar el reporte, ya que no esta montada la particion"<<endl<<endl;
        return 0;
...
int Reporte::Reporte_BM_Bloque(QString id_part, QString ruta, QString value){
    int posicion=Verificar_montaje(id_part);
    if(posicion==-1){
        cout<<"ERROR:: no se puede generar el reporte, ya que no esta montada la particion"<<endl<<endl;
        return 0;
...
int Reporte::Reporte_Inode(QString id_part, QString ruta, QString value){
    int posicion=Verificar_montaje(id_part);
    if(posicion==-1){
        cout<<"ERROR:: no se puede generar el reporte, ya que no esta montada la particion"<<endl<<endl;
        return 0;
...
int Reporte::Reporte_Bloque(QString id_part, QString ruta, QString value){
    int posicion=Verificar_montaje(id_part);
    if(posicion==-1){
        cout<<"ERROR:: no se puede generar el reporte, ya que no esta montada la particion"<<endl<<endl;
        return 0;
...
int Reporte::ReporteTree(QString id_part, QString ruta, QString value){
    int posicion=Verificar_montaje(id_part);
    if(posicion==-1){
        cout<<"ERROR:: no se puede generar el reporte, ya que no esta montada la particion"<<endl<<endl;
        return 0;
...
int Reporte::Tree_Inodo(int padre, int actual, int pos, ofstream &reporte, FILE *archivo,superBloque sb){
    inodo tem_i;
...
int Reporte::Tree_Bloque(int padre, int actual, int pos, ofstream &reporte, FILE *archivo, superBloque sb, int tipo){
...
int Reporte::Tree_Indirecto(int padre, int actual, int pos, ofstream &reporte, FILE *archivo, superBloque sb, int tipo){
    int apuntador=sb.start_bloque+(actual*sb.size_bloque);
    fseek(archivo,apuntador,SEEK_SET);
...
int Reporte::Indirecto_Simple(int padre, int actual, int pos, ofstream &reporte, FILE *archivo, superBloque sb, int tipo){
    int apuntador=sb.start_bloque+(actual*sb.size_bloque);
    fseek(archivo,apuntador,SEEK_SET);
...
int Reporte::Indirecto_Doble(int padre, int actual, int pos, ofstream &reporte, FILE *archivo, superBloque sb, int tipo){
    int apuntador=sb.start_bloque+(actual*sb.size_bloque);
    fseek(archivo,apuntador,SEEK_SET);
...
int Reporte::Indirecto_Triple(int padre, int actual, int pos, ofstream &reporte, FILE *archivo, superBloque sb, int tipo){
    int apuntador=sb.start_bloque+(actual*sb.size_bloque);
    fseek(archivo,apuntador,SEEK_SET);
...
int Reporte::Reporte_Journaling(QString id_part, QString ruta, QString value){
    int posicion=Verificar_montaje(id_part);
    if(posicion==-1){
        cout<<"ERROR:: no se puede generar el reporte, ya que no esta montada la particion"<<endl<<endl;
        return 0;
...
int Reporte::Reporte_File(QString id_part,QString ruta,QString value,QString ruta_archivo){
    int posicion=Verificar_montaje(id_part);
    if(posicion==-1){
        cout<<"ERROR:: no se puede generar el reporte, ya que no esta montada la particion"<<endl<<endl;
        return 0;
...
int Reporte::Buscar_Carpeta_Archivo(int pos_bmi,superBloque sb, QStringList rutas,int pos){
...
int Reporte::Buscar_Indirectos_C_A(QStringList rutas, superBloque sb, int indirecto, int pos_ruta, int block, FILE *archivo){
...
int Reporte::Recorrer_Bloque_Archivos(int pos_inodo,superBloque sb){
...
int Reporte::Reporte_Ls(QString id_part, QString ruta, QString value, QString ruta_archivo){
    int posicion=Verificar_montaje(id_part);
    if(posicion==-1){
        cout<<"ERROR:: no se puede generar el reporte, ya que no esta montada la particion"<<endl<<endl;
        return 0;
...
int Reporte::Buscar_Usuario(int id_usuario,int id_grupo,ofstream &reporte){
...
int Reporte::Datos_Usuario(int id_usuario,int id_grupo,QString contenido,ofstream &reporte){
...
int Reporte::Verificar_montaje(QString id_part){
    temporal_mount.estado='0';
